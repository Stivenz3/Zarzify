        ...
        <Grid container spacing={4} ref={staggerRef}>
          {[
            { 
              ...
              desc: 'Gestiona productos, categorías y stock con alertas automáticas de bajo inventario. Control total de tu almacén.',
              features: ['Gestión de productos', 'Control de stock', 'Alertas automáticas', 'Categorización']
            },
            { 
              icon: <PointOfSale />, 
              title: 'Ventas y Facturación', 
              desc: 'Registra ventas rápidas, genera comprobantes y maneja diferentes métodos de pago. Facturación profesional.',
              features: ['Ventas rápidas', 'Comprobantes PDF', 'Múltiples métodos de pago', 'Historial de ventas']
            },
            { 
              icon: <MoneyOff />, 
              title: 'Egresos y Gastos', 
              desc: 'Registra y categoriza todos tus gastos por empleado y categoría. Control financiero completo.',
              features: ['Registro de gastos', 'Categorización', 'Asignación por empleado', 'Reportes de egresos']
            },
            { 
              icon: <People />, 
              title: 'Gestión de Clientes', 
              desc: 'Mantén un registro detallado de tus clientes y su historial de compras. CRM integrado.',
              features: ['Base de datos de clientes', 'Historial de compras', 'Información de contacto', 'Segmentación']
            },
            { 
              icon: <Assessment />, 
              title: 'Reportes Avanzados', 
              desc: 'Visualiza métricas importantes con gráficos interactivos y exporta informes en PDF para análisis.',
              features: ['Dashboard con métricas', 'Gráficos interactivos', 'Exportación PDF', 'Análisis de tendencias']
            },
            { 
              icon: <Business />, 
              title: 'Multi-negocio', 
              desc: 'Gestiona múltiples negocios desde una sola cuenta con total independencia y control.',
              features: ['Múltiples negocios', 'Cambio rápido', 'Datos independientes', 'Usuarios por negocio']
            },
          ].map((feature, idx) => (
      ...
      <Container maxWidth="lg" sx={{ pb: 8, position: 'relative', zIndex: 2 }}>
        ...
        >
          ...
          <Typography variant="h6" color="text.secondary" sx={{ mb: 4, maxWidth: 600, mx: 'auto' }}>
            Únete a empresarios que ya están usando Zarzify para hacer crecer sus negocios
          </Typography>
